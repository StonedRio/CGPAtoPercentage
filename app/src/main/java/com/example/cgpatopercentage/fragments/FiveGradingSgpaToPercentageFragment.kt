...
import com.example.cgpatopercentage.databinding.FragmentFiveGradingSgpaToPercentageBinding
import com.example.cgpatopercentage.databinding.FragmentOutOfFourBinding

class FiveGradingSgpaToPercentageFragment : Fragment() {
    private var _binding: FragmentFiveGradingSgpaToPercentageBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFiveGradingSgpaToPercentageBinding.inflate(inflater, container, false)
        ...
        binding.btnConvert.setOnClickListener {
            ...
            if (sgpaText.isNotEmpty()) {
                ...
                if (sgpa != null && sgpa < 5.1 ) {
                    val percentage = (sgpa * 20)-7.5
