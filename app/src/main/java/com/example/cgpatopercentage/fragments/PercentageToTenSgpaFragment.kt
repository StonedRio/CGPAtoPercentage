...
class PercentageToTenSgpaFragment : Fragment() {


    private var _binding: FragmentPercentageToTenSgpaBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentPercentageToTenSgpaBinding.inflate(inflater, container, false)
