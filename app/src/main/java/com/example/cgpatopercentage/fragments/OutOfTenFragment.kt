...
class OutOfTenFragment : Fragment() {
    ...
    private var _binding: FragmentOutOfTenBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentOutOfTenBinding.inflate(inflater, container, false)
        ...
        binding.btnConvert.setOnClickListener {
            ...
            if (cgpaText.isNotEmpty()) {
                ...
                if (cgpa != null && cgpa < 10.1) {
                    val percentage = cgpa * 10
